  ...
  return (
    <Layout>
      <SEOHead
        ...
        keywords="Infinity Women Clinic photos, best women's clinic Maharashtra images, gynecological clinic gallery, women's health clinic interior, Dr. Trishna Taralkar clinic photos, patient care environment"
      />
